...
function TabKomponenController($scope, $location, toaster, globalService) {
    ...
    const listBelanjaPegawai = function () {
    ...
    const listBelanjaBarang = function () {
    ...
    const listBelanjaModal = function () {
            ...
            globalService.servicePostData(`/blud-resource-server/api/komponen-belanja/save/pegawai`, {
                ...
                if (result.status === 200) {
                    ...
                    toaster.pop({
                        type: 'success',
                        title: 'Berhasil',
                        body: 'Berhasil Simpan Komponen Belanja Pegawai',
                        timeout: 3000
                    });
                } else {
                    toaster.pop({
                        type: 'warning',
                        title: 'Gagal',
                        body: 'Gagal Simpan Komponen Belanja Pegawai',
                        timeout: 3000
                    });
                }
            });
            ...
            globalService.servicePostData(`/blud-resource-server/api/komponen-belanja/save/barang`, {
                ...
                if (result.status === 200) {
                    ...
                    toaster.pop({
                        type: 'success',
                        title: 'Berhasil',
                        body: 'Berhasil Simpan Komponen Belanja Barang & Jasa',
                        timeout: 3000
                    });
                } else {
                    toaster.pop({
                        type: 'warning',
                        title: 'Gagal',
                        body: 'Gagal Simpan Komponen Belanja Barang & Jasa',
                        timeout: 3000
                    });
                }
            });
            ...
            globalService.servicePostData(`/blud-resource-server/api/komponen-belanja/save/modal`, {
                ...
                if (result.status === 200) {
                    ...
                    toaster.pop({
                        type: 'success',
                        title: 'Berhasil',
                        body: 'Berhasil Simpan Komponen Belanja Modal',
                        timeout: 3000
                    });
                } else {
                    toaster.pop({
                        type: 'warning',
                        title: 'Gagal',
                        body: 'Gagal Simpan Komponen Belanja Modal',
                        timeout: 3000
                    });
                }
            });
